...
with open("c:/Users/dhruv/.gemini/antigravity/playground/sparse-halley/Final_Project_Customer_Prediction.ipynb", "w", encoding="utf-8") as f:
    json.dump(ipynb, f, indent=1)
